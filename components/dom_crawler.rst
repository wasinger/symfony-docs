...
.. note::
    ...
    For that use case, the `HtmlPageDom`_ project on Github extends 
    :class:`Symfony\\Component\\DomCrawler\\Crawler` by adding jQuery-style DOM manipulation functions.
